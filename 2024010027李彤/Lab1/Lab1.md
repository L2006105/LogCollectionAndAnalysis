...
![VMware 版本]
*Help → About VMware Workstation**，查看版本信息。
...
| 项目 | 你的填写内容 |
| :--- | :--- |
| 虚拟机 IP 地址 |192.168.222.128|
| 网络模式 | NAT / 其他：192.168.222.128 |
...
| 项目 | 你的填写内容 |
| :--- | :--- |
| 宿主机内存 / CPU 核心 / 存放盘剩余空间 |16GB/8核/D盘剩余80GB |
| 选择的配置档位 |  课程推荐|
| 虚拟 CPU 核心数 |2 |
| 虚拟内存 |5.7Gi |
| 虚磁盘容量 |20G |
...
| 验收项目 | 合格标准 | 你的结论 |
| :--- | :--- | :--- |
| VMware 版本 | VMware Workstation Pro 26H1 for Windows |符合 |
